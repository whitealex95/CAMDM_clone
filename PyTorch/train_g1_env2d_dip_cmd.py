...
Mirrors train_g1_env2d_dip.py except:
  - Network is MotionDiffusionCmdDiP (network/models_dip2d_cmd.py).
...
def train(config, resume, logger, tb_writer):
    ...
    logger.info(
        f"MotionDiffusionCmdDiP: env_sensor_dim={env_sensor_dim}, "

...
def add_train_args(parser):
    ...
    parser.add_argument('--legacy_rotation_aug', action='store_true', help='Use pre-5fad8d2 rotation aug (traj_pos not rotated).')
...
def config_parse(args):
    ...
    config.trainer.legacy_rotation_aug = args.legacy_rotation_aug

...
if __name__ == "__main__":
    ...
    parser.add_argument('-r', '--checkpoints', default='save/camdm_g1_lafan1_g1/best.pt', type=str, help='path to latest checkpoint (default: None)')
    ...
    model_config_json = {
        ...
        "joint_names": train_data.joint_names,
    }
